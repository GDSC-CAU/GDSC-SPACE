...
export const Tag = ({ isActive, children, twClass }: React.PropsWithChildren<TagProps>) => {
    return (
        <button
            type="button"
            className={`${twClass} flex items-center justify-center rounded-full border px-7 py-1 font-eng text-2xl opacity-100 transition-colors duration-300 hover:border-primary-blue active:opacity-75 ${
                isActive
