...
export function ThumbnailCard<ThumbnailMeta>({
    ...
    return (
        ...
        >
            <FillImage
                containerClass="flex h-44 w-full items-center justify-end overflow-hidden rounded-t-lg"
            ...
            <section className="flex h-40 w-full flex-col items-start justify-between overflow-y-hidden rounded-b-lg bg-black p-5">
                <div>
