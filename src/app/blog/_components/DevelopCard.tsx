...
export const DevelopCard = ({ article }: { article: BLOG_META }) => {
    return (
        <div className="flex w-full flex-col gap-y-3 rounded-2xl border border-black bg-black p-10 text-white transition-colors duration-300 hover:border-primary-blue">
